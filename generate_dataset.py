...
EVENTS = [
    ...
    ("P008","P002",MFC,"DEF",1,84,0,B,0,0,B,"84","Substituted off 84'"),
    ("P008","P018",MFC,"DEF",1,90,0,B,0,0,B,B,""),
    ("P008","P004",MFC,"DEF",1,90,0,B,0,0,B,B,""),
    ("P008","P005",MFC,"DEF",1,64,0,B,0,0,B,"64","Substituted off 64' (injury)"),
    ("P008","P006",MFC,"MID",1,84,0,B,0,0,B,"84","Substituted off 84'"),
    ("P008","P007",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P008","P014",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P008","P010",MFC,"MID",1,64,0,B,0,0,B,"64","Substituted off 64'"),
    ("P008","P008",MFC,"FWD",1,90,1,B,0,0,B,B,"Goal: 22'"),
    ("P008","P017",MFC,"FWD",1,63,0,B,0,0,B,"63","First Premiership start; substituted off 63'"),
    ("P008","P012",MFC,"DEF",0,26,0,B,0,0,"64",B,"On for Longelo 64' (injury)"),
    ("P008","P016",MFC,"MID",0,26,0,B,0,0,"64",B,"On for Just 64'"),
    ("P008","P015",MFC,"MID",0,6, 0,B,0,0,"84",B,"On for Fadinger 84'"),
    ("P008","P013",MFC,"DEF",0,6, 0,B,0,0,"84",B,"On for Koutroumbis 84'"),
    ("P008","P011",MFC,"FWD",0,27,0,B,0,0,"63",B,"On for Hendry 63'"),
    ...
    ("P009","P003",MFC,"DEF",1,60,0,B,0,0,B,"60","Substituted off ~60' for McGinn"),
    ...
    ("P009","P008",MFC,"FWD",1,60,0,B,0,0,B,"60","Substituted off ~60' for Slattery"),
    ("P009","P010",MFC,"MID",1,90,1,B,0,0,B,B,"Goal: 90+3' (assisted by Slattery – as sub)"),
    ("P009","P014",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P009","P011",MFC,"FWD",1,90,1,B,0,0,B,B,"Goal: 59' (penalty)"),
    ("P009","P009",MFC,"MID",0,30,0,1,0,0,"60",B,"Came on ~60' for Maswanhise; assist on Just 90+3'"),
    ("P009","P004",MFC,"DEF",0,30,0,B,0,0,"60",B,"On for Gordon ~60'"),
    ("P009","OPP_BOK","Livingston","FWD",1,B,1,B,0,0,B,B,"Goal: 26' (penalty)"),
    ...
    ("P019","P002",MFC,"DEF",1,69,0,B,0,0,B,"69","Triple sub 69'; O'Donnell on"),
    ("P019","P004",MFC,"DEF",1,90,0,B,0,0,B,B,""),
    ("P019","P018",MFC,"DEF",1,90,0,B,0,0,B,B,""),
    ("P019","P005",MFC,"DEF",1,90,0,B,0,0,B,B,""),
    ("P019","P013",MFC,"DEF",1,84,0,B,0,0,B,"84","Substituted off 84'"),
    ("P019","P007",MFC,"MID",1,91,0,B,0,0,B,"91","Substituted off 90+1'"),
    ("P019","P006",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P019","P010",MFC,"MID",1,69,0,B,0,0,B,"69","Triple sub 69'; Slattery on"),
    ("P019","P014",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P019","P017",MFC,"FWD",1,69,0,B,0,0,B,"69","Triple sub 69'; Stamatelopoulos on"),
    ("P019","P009",MFC,"MID",0,21,0,B,0,0,"69",B,"On for Just 69' (triple sub)"),
    ("P019","P011",MFC,"FWD",0,21,0,B,0,0,"69",B,"On for Hendry 69' (triple sub)"),
    ("P019","P012",MFC,"DEF",0,21,0,B,0,0,"69",B,"On for Koutroumbis 69' (triple sub)"),
    ("P019","P023",MFC,"FWD",0,6, 0,B,0,0,"84",B,"On for Sparrow 84'"),
    ("P019","P015",MFC,"MID",0,2, 0,B,0,0,"91",B,"On for Watt 90+1'"),
    ...
    ("P021","P007",MFC,"MID",1,73,1,B,0,0,B,"73","Goal: 57'; subbed off 73' (injury)"),
    ("P021","P010",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P021","P009",MFC,"MID",1,90,0,B,0,0,B,"90","Substituted off 90'"),
    ("P021","P006",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P021","P008",MFC,"FWD",1,73,1,B,0,0,B,"73","Goal: ~35'; substituted off 73'"),
    ("P021","P014",MFC,"FWD",1,90,0,B,0,0,B,B,""),
    ("P021","P015",MFC,"MID",0,17,0,B,0,0,"73",B,"On for Watt 73' (injury)"),
    ("P021","P013",MFC,"DEF",0,17,0,B,0,0,"73",B,"On for Maswanhise 73'"),
    ("P021","P025",MFC,"MID",0,0, 0,B,0,0,"90",B,"On for Slattery 90'"),

    # ── P022  Hibernian 1-1 Motherwell  10 Jan 2026 ───────────────────────
    ("P022","P001",MFC,"GK", 1,90,0,B,0,0,B,B,""),
    ("P022","P012",MFC,"DEF",1,20,0,B,0,0,B,"20","Substituted off 20' (injury)"),
    ...
    ("P022","P002",MFC,"DEF",0,70,0,B,0,0,"20",B,"On for O'Donnell 20' (injury)"),
    ...
    ("P025","P012",MFC,"DEF",1,68,0,B,0,0,B,"68","Substituted off 68'"),
    ...
    ("P025","P014",MFC,"MID",1,68,0,B,0,0,B,"68","Substituted off 68'"),
    ("P025","P010",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P025","P008",MFC,"FWD",1,90,0,B,0,0,B,B,""),
    ("P025","P013",MFC,"DEF",0,22,0,B,0,0,"68",B,"On for O'Donnell 68'"),
    ("P025","P019",MFC,"MID",0,22,0,1,0,0,"68",B,"On for Sa'id 68'; flick-on assisted Welsh's equaliser"),
    ...
    ("P027","P004",MFC,"DEF",1,62,0,B,0,0,B,"62","Substituted off 62'"),
    ("P027","P018",MFC,"DEF",1,90,0,B,0,0,B,B,""),
    ("P027","P005",MFC,"DEF",1,90,1,B,0,0,B,B,"Goal: 58' (4th of the match)"),
    ("P027","P015",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P027","P007",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P027","P009",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P027","P010",MFC,"MID",1,90,1,B,0,0,B,B,"Goal: 14'"),
    ("P027","P014",MFC,"MID",1,90,1,B,0,0,B,B,"Goal: 49'"),
    ("P027","P008",MFC,"FWD",1,90,1,B,0,0,B,B,"Goal: 30' (pen)"),
    ("P027","P019",MFC,"MID",0,28,1,B,0,0,"62",B,"On for McGinn 62'; scored 5th goal at 65'"),
    ...
    ("P031","P010",MFC,"MID",1,85,0,B,0,0,B,"85","Came off ~85' (injury); goal disallowed VAR"),
    ("P031","P019",MFC,"MID",0,5, 0,B,0,0,"85",B,"On for Just ~85'"),
    ...
    ("P035","P026",MFC,"MID",0,28,0,B,0,0,"62",B,"On ~62' (chasing game)"),
    ("P035","P017",MFC,"FWD",0,14,0,B,0,0,"76",B,"On ~76'"),
    ("P035","P014",MFC,"MID",0,28,0,B,0,0,"62",B,"On ~62'"),
    ("P035","P016",MFC,"MID",0,14,0,B,0,0,"76",B,"On ~76'"),
