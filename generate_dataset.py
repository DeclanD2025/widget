...
PLAYERS = {
    ...
    "P039": ("Kofi Balmer",                  "SCO", "DEF"),
    "P040": ("Andy Halliday",                "SCO", "MID"),
    "P041": ("Blane McColm",                 "SCO", "MID"),
    "P042": ("Blane Watson",                 "SCO", "DEF"),
    "P043": ("Aston Oxborough",              "ENG", "GK"),
...
EVENTS = [
    ...
    ("P011","P008",MFC,"FWD",1,65,0,B,0,0,B,"65","Substituted off 65'"),
    ("P011","P010",MFC,"MID",1,90,1,B,0,0,B,B,"Goal: 64' (assisted by Slattery)"),
    ("P011","P011",MFC,"FWD",1,65,0,B,0,0,B,"65","Substituted off 65'"),
    ("P011","P017",MFC,"FWD",0,25,0,B,0,0,"65",B,"On for Maswanhise 65'"),
    ("P011","P014",MFC,"MID",0,25,0,B,0,0,"65",B,"On for Stamatelopoulos 65'"),
    ("P011","P023",MFC,"FWD",0,B, 0,B,0,0,"90",B,"On ~90' (replacement unconfirmed)"),
    ("P011","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P011","P039",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P011","P003",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P011","P013",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P011","P015",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P011","P016",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P012","P005",MFC,"DEF",1,63,0,B,0,0,B,"63","Substituted off 63' (triple sub)"),
    ("P012","P006",MFC,"MID",1,88,0,B,0,0,B,"88","Substituted off 88'"),
    ("P012","P007",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P012","P009",MFC,"MID",1,63,0,B,0,0,B,"63","Substituted off 63' (triple sub)"),
    ("P012","P008",MFC,"FWD",1,76,2,B,0,0,B,"76","Goals: 16' and 26'; substituted off 76'"),
    ("P012","P014",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P012","P017",MFC,"FWD",1,63,0,B,0,0,B,"63","Substituted off 63' (triple sub)"),
    ("P012","P003",MFC,"DEF",0,27,0,B,0,0,"63",B,"On for Longelo 63' (triple sub)"),
    ("P012","P010",MFC,"MID",0,27,0,B,0,0,"63",B,"On for Hendry 63' (triple sub)"),
    ("P012","P011",MFC,"FWD",0,27,1,B,0,0,"63",B,"On for Slattery 63' (triple sub); Goal: 68' (pen)"),
    ("P012","P013",MFC,"DEF",0,14,0,B,0,0,"76",B,"On for Maswanhise 76'"),
    ("P012","P015",MFC,"MID",0,2, 0,B,0,0,"88",B,"On for Fadinger 88'"),
    ("P012","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P012","P039",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P012","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P012","P016",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P013","P013",MFC,"DEF",1,67,0,B,0,0,B,"67","Right wing-back; substituted off ~67'"),
    ...
    ("P013","P015",MFC,"MID",1,82,0,B,0,0,B,"82","Substituted off ~82'"),
    ("P013","P016",MFC,"MID",1,82,0,B,0,0,B,"82","Substituted off ~82'"),
    ("P013","P010",MFC,"MID",1,67,0,B,0,0,B,"67","Substituted off ~67'"),
    ("P013","P008",MFC,"FWD",1,90,1,B,0,0,B,B,"Goal: 19' (pen)"),
    ("P013","P009",MFC,"MID",0,23,0,B,0,0,"67",B,"On for Sparrow ~67'"),
    ("P013","P014",MFC,"MID",0,23,0,B,0,0,"67",B,"On for Just ~67'"),
    ("P013","P022",MFC,"FWD",0,8, 0,B,0,0,"82",B,"On for Priestman ~82'"),
    ("P013","P023",MFC,"FWD",0,8, 0,B,0,0,"82",B,"On for Charles-Cook ~82'"),
    ("P013","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P013","P039",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P013","P017",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P014","P017",MFC,"FWD",1,B, 0,B,0,0,B,B,"Substituted off (minute unconfirmed)"),
    ("P014","P008",MFC,"FWD",1,B, 0,B,0,0,B,B,"Substituted off (minute unconfirmed)"),
    ...
    ("P014","P012",MFC,"DEF",0,B, 0,B,0,0,B, B,"Came on as substitute (minute unconfirmed)"),
    ("P014","P014",MFC,"MID",0,B, 0,B,0,0,B, B,"Came on as substitute (minute unconfirmed)"),
    ("P014","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P014","P003",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P014","P039",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P014","P015",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),

    # ── P015  Falkirk 0-0 Motherwell  3 Dec 2025 ──────────────────────────
    ("P015","P001",MFC,"GK", 1,90,0,B,0,0,B,B,""),
    ("P015","P013",MFC,"DEF",1,62,0,B,0,0,B,"62","Substituted off ~62' (replacement unconfirmed)"),
    ...
    ("P015","P015",MFC,"MID",1,62,0,B,0,0,B,"62","Substituted off ~62' (replacement unconfirmed)"),
    ("P015","P009",MFC,"MID",1,74,0,B,0,0,B,"74","Substituted off ~74' (replacement unconfirmed)"),
    ("P015","P014",MFC,"MID",1,74,0,B,0,0,B,"74","Substituted off ~74' (replacement unconfirmed)"),
    ("P015","P008",MFC,"FWD",1,89,0,B,0,0,B,"89","Substituted off ~89' (replacement unconfirmed)"),
    ("P015","P017",MFC,"FWD",1,90,0,B,0,0,B,B,""),
    ("P015","P010",MFC,"MID",0,28,0,B,0,0,"62",B,"On ~62' (replacement unconfirmed)"),
    ("P015","P002",MFC,"DEF",0,28,0,B,0,0,"62",B,"On ~62' (replacement unconfirmed)"),
    ("P015","P012",MFC,"DEF",0,16,0,B,0,0,"74",B,"On ~74' (replacement unconfirmed)"),
    ("P015","P011",MFC,"FWD",0,16,0,B,0,0,"74",B,"On ~74' (replacement unconfirmed)"),
    ("P015","P016",MFC,"MID",0,1, 0,B,0,0,"89",B,"On ~89' (replacement unconfirmed)"),
    ("P015","P043",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P015","P003",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P015","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P015","P023",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P016","P002",MFC,"DEF",1,70,0,B,0,0,B,"70","Substituted off ~70' (triple sub)"),
    ("P016","P016",MFC,"MID",1,90,0,1,0,0,B,B,"Assist on Longelo 88'"),
    ("P016","P007",MFC,"MID",1,70,1,B,0,0,B,"70","Goal: 18'; substituted off ~70' (triple sub)"),
    ...
    ("P016","P010",MFC,"MID",1,70,0,B,0,0,B,"70","Substituted off ~70' (triple sub)"),
    ("P016","P017",MFC,"FWD",0,29,0,B,0,0,"61",B,"On for Stamatelopoulos ~61'"),
    ("P016","P005",MFC,"DEF",0,20,1,B,0,0,"70",B,"On for Koutroumbis ~70' (triple sub); Goal: 88'"),
    ("P016","P015",MFC,"MID",0,20,0,B,0,0,"70",B,"On for Watt ~70' (triple sub)"),
    ("P016","P009",MFC,"MID",0,20,0,B,0,0,"70",B,"On for Just ~70' (triple sub)"),
    ("P016","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P016","P013",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P016","P018",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P016","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P016","P014",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P017","P018",MFC,"DEF",1,18,0,B,0,0,B,"18","Forced off 18' (head clash)"),
    ...
    ("P017","P009",MFC,"MID",1,73,0,B,0,0,B,"73","Substituted off ~73'"),
    ("P017","P017",MFC,"FWD",1,73,0,B,0,0,B,"73","Substituted off ~73'"),
    ("P017","P003",MFC,"DEF",0,72,0,B,0,0,"18",B,"On for Welsh 18'"),
    ("P017","P014",MFC,"MID",0,17,0,B,0,0,"73",B,"On for Slattery ~73'"),
    ("P017","P005",MFC,"DEF",0,17,0,B,0,0,"73",B,"On for Hendry ~73'"),
    ("P017","P016",MFC,"MID",0,B, 0,B,0,0,B, B,"Came on as substitute (minute unconfirmed)"),
    ("P017","P011",MFC,"FWD",0,B, 0,B,0,0,B, B,"Came on as substitute (minute unconfirmed)"),
    ("P017","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P017","P024",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P017","P013",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P017","P019",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P017","P015",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P018","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P018","P023",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P018","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P019","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P019","P003",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P019","P016",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P019","P025",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P019","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P020","P013",MFC,"DEF",1,85,0,B,0,0,B,"85","Substituted off ~85'"),
    ("P020","P007",MFC,"MID",1,90,1,B,0,0,B,B,"Goal: 58'"),
    ("P020","P015",MFC,"MID",1,75,0,B,0,0,B,"75","Substituted off ~75' (double sub)"),
    ("P020","P006",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P020","P009",MFC,"MID",1,75,0,B,0,0,B,"75","Substituted off ~75' (double sub)"),
    ("P020","P010",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P020","P014",MFC,"MID",1,90,1,B,0,0,B,B,"Goal: 14'"),
    ("P020","P017",MFC,"FWD",0,18,0,B,0,0,"75",B,"On for Priestman ~75' (double sub)"),
    ("P020","P023",MFC,"FWD",0,18,0,B,0,0,"75",B,"On for Slattery ~75' (double sub)"),
    ("P020","P005",MFC,"DEF",0,8, 0,B,0,0,"85",B,"On for Sparrow ~85'"),
    ("P020","P025",MFC,"MID",0,B, 0,B,0,0,"90",B,"On ~90+3' (late sub)"),
    ("P020","P022",MFC,"FWD",0,B, 0,B,0,0,"90",B,"On ~90+3' (late sub)"),
    ("P020","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P020","P003",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P020","P039",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P020","P011",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P031","P015",MFC,"MID",1,66,0,B,0,0,B,"66","Substituted off ~66'"),
    ("P031","P008",MFC,"FWD",1,90,0,B,0,0,B,B,""),
    ("P031","P010",MFC,"MID",1,85,0,B,0,0,B,"85","Came off ~85' (injury); goal disallowed VAR"),
    ("P031","P014",MFC,"MID",0,24,0,B,0,0,"66",B,"On for Priestman ~66'"),
    ("P031","P019",MFC,"MID",0,5, 0,B,0,0,"85",B,"On for Just ~85'"),
    ("P031","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P031","P003",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P031","P024",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P031","P025",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P031","P040",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P031","P026",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P031","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),

    # ── P032  Motherwell 2-3 Falkirk  4 Apr 2026 ──────────────────────────
    # Longelo suspended; Slattery suspended
    ...
    ("P032","P014",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ...
    ("P032","P019",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P032","P008",MFC,"FWD",1,90,1,B,0,0,B,B,"Goal: 90+4' (assisted by Just)"),
    ("P032","P015",MFC,"MID",0,B, 0,B,0,0,B, B,"Came on as substitute (minute unconfirmed)"),
    ("P032","P024",MFC,"DEF",0,B, 0,B,0,0,B, B,"Came on as substitute (minute unconfirmed)"),
    ("P032","P026",MFC,"MID",0,B, 0,B,0,0,B, B,"Came on as substitute (minute unconfirmed)"),
    ("P032","P022",MFC,"FWD",0,B, 0,B,0,0,B, B,"Came on as substitute (minute unconfirmed)"),
    ("P032","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P032","P025",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P032","P040",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P032","P041",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P032","P042",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P033","P015",MFC,"MID",0,1, 0,B,0,0,"89",B,"On ~89' (replacement unconfirmed)"),
    ("P033","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P033","P003",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P033","P040",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P033","P025",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P033","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P034","P009",MFC,"MID",1,77,0,B,0,0,B,"77","Substituted off ~77'"),
    ("P034","P008",MFC,"FWD",1,90,0,B,0,0,B,B,""),
    ("P034","P010",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P034","P003",MFC,"DEF",0,35,0,B,0,0,"55",B,"On for Welsh 55'"),
    ("P034","P017",MFC,"FWD",0,13,0,B,0,0,"77",B,"On for Slattery ~77'"),
    ("P034","P016",MFC,"MID",0,B, 0,B,0,0,"90",B,"On ~90' (replacement unconfirmed)"),
    ("P034","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P034","P024",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P034","P015",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P034","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P034","P026",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P034","P014",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P035","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P035","P003",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P035","P024",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P035","P015",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P035","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P036","P014",MFC,"MID",1,77,0,B,0,0,B,"77","Substituted off ~77'"),
    ("P036","P009",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P036","P008",MFC,"FWD",1,86,0,B,0,0,B,"86","Substituted off ~86'"),
    ("P036","P010",MFC,"MID",1,86,0,B,0,0,B,"86","Substituted off ~86'"),
    ("P036","P002",MFC,"DEF",0,13,0,B,0,0,"77",B,"On for Sa'id ~77'"),
    ("P036","P016",MFC,"MID",0,4, 0,B,0,0,"86",B,"On for Maswanhise ~86'"),
    ("P036","P017",MFC,"FWD",0,4, 0,B,0,0,"86",B,"On for Just ~86'"),
    ("P036","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P036","P013",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P036","P040",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P036","P026",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P036","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P036","P019",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P037","P013",MFC,"DEF",1,90,0,B,0,0,B,B,""),
    ("P037","P012",MFC,"DEF",1,90,0,B,0,0,B,B,"Captain"),
    ("P037","P002",MFC,"DEF",1,90,0,B,0,0,B,B,""),
    ("P037","P005",MFC,"DEF",1,90,0,B,0,0,B,B,""),
    ("P037","P007",MFC,"MID",1,90,1,B,0,0,B,B,"Goal: 17'"),
    ("P037","P009",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P037","P006",MFC,"MID",1,68,0,B,0,0,B,"68","Substituted off ~68'"),
    ("P037","P014",MFC,"MID",1,81,0,B,0,0,B,"81","Substituted off ~81'"),
    ("P037","P008",MFC,"FWD",1,88,0,B,0,0,B,"88","Substituted off ~88'"),
    ("P037","P010",MFC,"MID",1,81,0,B,0,0,B,"81","Substituted off ~81'"),
    ("P037","P016",MFC,"MID",0,22,0,B,0,0,"68",B,"On for Fadinger ~68'"),
    ("P037","P003",MFC,"DEF",0,9, 1,B,0,0,"81",B,"On for Sa'id ~81'; Goal: 85'"),
    ("P037","P026",MFC,"MID",0,9, 0,B,0,0,"81",B,"On for Just ~81'"),
    ("P037","P017",MFC,"FWD",0,2, 0,B,0,0,"88",B,"On ~88'"),
    ("P037","P015",MFC,"MID",0,2, 0,B,0,0,"88",B,"On for Maswanhise ~88'"),
    ("P037","P021",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P037","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P037","P018",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P037","P020",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
    ...
    ("P038","P021",MFC,"GK", 1,90,0,B,0,0,B,B,""),
    ("P038","P002",MFC,"DEF",1,90,0,B,0,0,B,B,""),
    ("P038","P013",MFC,"DEF",1,90,0,B,0,0,B,B,""),
    ...
    ("P038","P007",MFC,"MID",1,65,0,B,2,1,B,"65","Second yellow (= red) ~65'; dismissed – MFC finished with 10 men"),
    ("P038","P014",MFC,"MID",1,73,0,B,0,0,B,"73","Substituted off ~73'"),
    ("P038","P009",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P038","P008",MFC,"FWD",1,83,0,B,0,0,B,"83","Substituted off ~83'"),
    ("P038","P010",MFC,"MID",1,90,0,B,0,0,B,B,""),
    ("P038","P015",MFC,"MID",0,17,0,B,0,0,"73",B,"On for Sa'id ~73'"),
    ("P038","P017",MFC,"FWD",0,7, 0,B,0,0,"83",B,"On for Maswanhise ~83'"),
    ("P038","P012",MFC,"DEF",0,B, 0,B,0,0,"87",B,"On ~87' (late introduction)"),
    ("P038","P001",MFC,"GK", 0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P038","P003",MFC,"DEF",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P038","P026",MFC,"MID",0,0, 0,B,0,0,B,B,"Unused bench"),
    ("P038","P022",MFC,"FWD",0,0, 0,B,0,0,B,B,"Unused bench"),
]
